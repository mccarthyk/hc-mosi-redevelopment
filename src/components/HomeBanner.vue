  ...
  <section class="py-5 banner">
    <div class="container my-5">
      ...
      <div class="py-5 my-5 text-center">
        ...
        >Hillsborough County Seeks Master Developer to Redevelop 74-acre site in the heart of Tampa Bay's Innovation District</h2>
      </div>
      ...
      <div class="d-xl-flex mt-5">
        <div class="col-xl-6">
          <a
            ...
            target="_blank"
            class="btn btn-block btn-outline-dark btn-lg display-4 my-3"
          >View the RFP</a>
        </div>
        <div class="col-xl-6">
          <a
            href="https://www.hillsboroughcounty.org/en/government/departments/procurement"
            target="_blank"
            class="btn btn-block btn-outline-dark btn-lg display-4 my-3"
          >Contact Procurement Services</a>
        </div>
      </div>
